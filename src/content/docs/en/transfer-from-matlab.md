---
title: "Transformation from MATLAB to PyTorch and EvoX"
order: 18
section: "misc"
---
...
- Built-In Workflow Integration
    When you register your PSO class with a workflow `StdWorkflow`, it handles iterative calls to `step()` on your behalf.
