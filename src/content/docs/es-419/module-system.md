---
title: "Trabajo con Modulos en EvoX"
order: 4
section: "developer"
---
...
<center><b>Iniciar un algoritmo y un problema -- Configurar un monitor -- Iniciar un flujo de trabajo -- Ejecutar el flujo de trabajo</b></center>
...
| `add_mutable`     | `(self, name: str, value: Union[torch.Tensor \| nn.Module, Sequence[torch.Tensor \| nn.Module], Dict[str, torch.Tensor \| nn.Module]]) -> None` | Definir un valor mutable en este modulo que puede ser accedido via `self.[nombre]` y modificado en su lugar. |
...
por favor usa [`torch.cond`](https://pytorch.org/docs/main/generated/torch.cond.html#torch.cond) para definir explicitamente el flujo de control.
