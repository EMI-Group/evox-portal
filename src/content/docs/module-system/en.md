---
title: "Working with Module in EvoX"
order: 4
section: "developer"
---
...
In the [tutorial](../../tutorials), we have mentioned the basic running process in EvoX:
...
The `ModuleBase` class is inherited from [`torch.nn.Module`](https://pytorch.org/docs/stable/generated/torch.nn.Module.html#).
