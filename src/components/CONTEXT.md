...
- **`pages/HomeContent.astro`** — Homepage body (see `pages/CONTEXT.md`): hero fly-in animation, news/releases cards, ecosystem, community (QQ QR modal + Discord), own `<Header animated>` + `<Footer>`.
