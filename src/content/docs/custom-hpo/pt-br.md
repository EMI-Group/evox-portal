...
Neste capítulo, focaremos na implantação de HPO com algoritmos personalizados, enfatizando os detalhes em vez do fluxo de trabalho geral. Uma breve introdução à implantação de HPO é fornecida no [tutorial](/pt-br/tutorials/practical-examples), e a leitura prévia é altamente recomendada.
