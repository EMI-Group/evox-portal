...
We initiate a [PSO algorithm](#evox.algorithms.so.pso_variants.pso.PSO), and the problem is a [Brax problem](#evox.problems.neuroevolution.brax.BraxProblem) in "swimmer" environment.
