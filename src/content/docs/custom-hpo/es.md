...
En este capítulo, nos centraremos en el despliegue de HPO con algoritmos personalizados, haciendo hincapié en los detalles más que en el flujo de trabajo general. Se proporciona una breve introducción al despliegue de HPO en el [tutorial](../../tutorials/practical-examples), y se recomienda encarecidamente su lectura previa.
